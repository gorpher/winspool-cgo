...
type Printer struct {
	...
	State               *model.PrinterStateSection       // CUPS: various;                     GCP: semantic_state field
	Description         *model.PrinterDescriptionSection // CUPS: translated PPD;              GCP: capabilities field
